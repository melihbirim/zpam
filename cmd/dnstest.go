...
var dnsTestServerStartCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		fmt.Printf("🧪 ZPAM DNS Test Server\n")
		fmt.Printf("═══════════════════════════════════════\n")
		...
		fmt.Printf("💡 Use 'zpam dnstest demo' to see performance comparison\n")
		fmt.Printf("📈 Use 'zpam dnstest benchmark' to run detailed benchmarks\n")
...
var dnsTestServerStatsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Printf("💡 Use 'zpam dnstest server start' to start the server\n")
...
var dnsTestDemoCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		fmt.Printf("🧪 ZPAM DNS Performance Demonstration\n")
		fmt.Printf("═══════════════════════════════════════\n\n")
...
var dnsTestBenchmarkCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		fmt.Printf("🧪 ZPAM DNS Client Benchmark\n")
		fmt.Printf("═══════════════════════════════════════\n\n")
...
func generateDNSTestConfig() string {
	return `# ZPAM Spam Filter Configuration - DNS Testing Mode
